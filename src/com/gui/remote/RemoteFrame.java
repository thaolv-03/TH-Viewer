...
public class RemoteFrame extends JFrame implements Runnable {
    ...
    private void initComponents() throws RemoteException {
        ...
        this.menu_bar.setFont(new Font("Inter", Font.PLAIN, 14));
    ...
    private void menuMonitorMouseEntered(MouseEvent e) {
        this.menu_monitor.setFont(new Font("Inter", Font.BOLD, 16));
        this.setCursor(new Cursor(Cursor.HAND_CURSOR));
    }

    private void menuMonitorMouseExited(MouseEvent e) {
        this.menu_monitor.setFont(new Font("Inter", Font.PLAIN, 14));
