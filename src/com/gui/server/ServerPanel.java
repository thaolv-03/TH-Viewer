...
public class ServerPanel extends JPanel implements Runnable {
    ...
    private void initComponents() {
        ...
        this.status_label.setText("Trạng thái: Đã ngắt kết nối");
        this.status_label.setBounds(30, 200, 200, 20);
        this.status_label.setFont(new Font("Inter", Font.ITALIC | Font.BOLD, 13));
...
//                this.listen_label.resetFont();
                ...
                this.status_label.setText("Trạng thái: Đang kết nối...");
                this.status_label.setForeground(Color.decode(ServerPanel.LISTENING_FOREGROUND));
            }
            catch(Exception exception) {
                JOptionPane.showMessageDialog(this, "Không thể bắt đầu kết nối trên máy chủ:\n" + exception.getMessage());
            }
        }
    }
...
//                this.stop_label.resetFont();
                ...
                JOptionPane.showMessageDialog(this, "Không thể dừng kết nối trên máy chủ:\n" + exception.getMessage());
            }
        }
    }
