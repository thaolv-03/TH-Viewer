...
public class MainChatPanel extends JPanel {
    ...
    private void initComponents() {
        ...
        this.connections_label.setText("<html>Tất cả các kết nối <font color='red'>(" + this.count + ")</font></html>");
        this.connections_label.setBounds(0, 0, 100, 15);
        this.connections_label.setFont(new Font("Inter", Font.PLAIN, 13));
    ...
    private void popupMenuMouseEntered(MouseEvent e) {
        this.connections_label.setFont(new Font("Inter", Font.BOLD, 13));
